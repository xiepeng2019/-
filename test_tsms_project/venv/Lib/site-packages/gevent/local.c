...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_6gevent_9_greenlet__dummy_event = __Pyx_ImportType(__pyx_t_3, "gevent._greenlet", "_dummy_event", sizeof(struct __pyx_obj_6gevent_9_greenlet__dummy_event), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6gevent_9_greenlet__dummy_event) __PYX_ERR(3, 186, __pyx_L1_error)
  __pyx_vtabptr_6gevent_9_greenlet__dummy_event = (struct __pyx_vtabstruct_6gevent_9_greenlet__dummy_event*)__Pyx_GetVtable(__pyx_ptype_6gevent_9_greenlet__dummy_event->tp_dict); if (unlikely(!__pyx_vtabptr_6gevent_9_greenlet__dummy_event)) __PYX_ERR(3, 186, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_RefNannyFinishContext();
